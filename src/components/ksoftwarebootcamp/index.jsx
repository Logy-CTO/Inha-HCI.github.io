    ...
    <ContentWrapper>
      ...
      <div className={Style.content_container}>
        ...
        <div className={Style.program_intro}>
          ...
          <h5 className={Style.first_h5}>본 프로그램은 총 640시간으로 구성되어 있으며 280시간은 대학 연합으로 프로그래밍, SW 기술에 대한 교육으로 360시간은 참여기업 주관의 프로젝트 심화 과목으로 구성되어 있습니다.</h5>
          ...
          <StaticImage src="../../assets/basicProgramming.png"></StaticImage>
          {/* 이제 SW이론 교육 기초 */}
          <div className={Style.third_title}>SW이론교육(기초)</div>
          <h5>- SW개발은 단순히 언어를 잘하는 것이 아니라 다양한 문제를 해결할 수 있는 능력이 중요합니다.<br/><br/>
          - SW이론교육에서는 여러가지 응용문제들을 해결하는 능력을 기르고 데이터를 다루는 세부적인 방법에 대해 배울 수 있습니다.<br/><br/>
          - SW이론교육-기초 커리큘럼을 이수하기 위해서는 2가지 필수 과목을 수강하여야 합니다.</h5>
          <StaticImage src="../../assets/SWTheory.png"></StaticImage>
          {/* 이제 SW기술역량 교육(심화) */}
          <div className={Style.third_title}>SW기술역량 교육(심화)</div>
          <h5>- SW 개발은 여러가지 분야가 존재합니다. 현업에서 사용할 수 있는 기술을 배우기 위해 SW기술역량 교육은 여러가지 분야에 대한 이론 및 실습 강좌를 통해 현업 SW개발자가 되기 위한 준비를 도와줍니다.<br/><br/>
          - SW 기술역량 교육-심화 커리큘럼을 이수하기 위해서는 필수과목 2개와 최소 1과목의 선택과목을 수강하여야 합니다.</h5>
          <StaticImage src="../../assets/images/SWTechAbility.png"></StaticImage>
        </div>
        {/* prgintro 끝  */}
        ...
        <div className={Style.company_project}>
          ...
          <div className={Style.second_title}>스마트 팩토리</div>
          ...
          <StaticImage src="../../assets/images/smartFactory.png"></StaticImage>
          <div className={Style.second_title}>헬스케어</div>
          ...
          <StaticImage src="../../assets/images/healthCare.png"></StaticImage>
          <div className={Style.second_title}>게임</div>
          ...
          <StaticImage src="../../assets/images/game.png"></StaticImage>
        </div>
        ...
        <div className={Style.schedule_box}>
          ...
          <h4>교육 시작일</h4>
          <h5>2022년 7월 15일</h5>
          <StaticImage src="../../assets/images/schedule.png"></StaticImage>
        </div>
        ...
        <div className={Style.faculty}>
          ...
          <div className={Style.first_title}>이서진 교수님</div>
        </div>
        ...
        <div className={Style.contact}>
          ...
          <div className={Style.first_title}>이메일</div>
          <h5>x21999@inha.ac.kr</h5>
          <div className={Style.first_title}>전화번호</div>
          <h5>032-860-9504</h5>
          <div className={Style.first_title}>오시는 길</div>
          <h5>인천광역시 남구 용현동 인하로 100</h5>
          <h5>60주년 기념관 1406호</h5>
          <StaticImage src="../../assets/images/map4here.png"></StaticImage>
        </div>
      </div>
    </ContentWrapper>
  )
