...
const Papers = () => {
  return (
    <div className={PaperStyle.PaperWrapper}>
      <div className={PaperStyle.innerWrapper}>
        <div>
          <h4>International</h4>
          <ul>
            <li>
            ...
            <li>
              A Filament Supply System Capable of Remote Monitoring and
              Automatic Humidity Control for 3D Printer , JOURNAL OF SENSORS ,
              2020
            </li>
            <li>
            ...
            <li>
              ...
              fuzzy logic control , JOURNAL OF CENTRAL SOUTH UNIVERSITY , 23권
              5호 , pp. 1208~1214 , 2016
            </li>
            <li>
              ...
              ELECTRONICS COMMUNICATIONS AND COMPUTER SCIENCES , E97A권 7호 ,
              pp. 1615~1618 , 2014
            </li>
            <li>
              State Machine and Downhill Simplex Approach for Vision-Based
              Nighttime Vehicle Detection , ETRI JOURNAL , 36 , pp. 439~449 ,
              2014
            </li>
            <li>
            ...
            <li>
              Personalized Document Summarization Using Pseudo Relevance
              Feedback and Semantic Feature , IETE JOURNAL OF RESEARCH , 58 권
              2호 , pp. 155~165 , 2012
            </li>
            <li>
            ...
            <li>
              Large-Scale Joint Rate and Power Allocation Algorithm Combined
              with Admission Control in Cognitive Radio Networks , JOURNAL OF
              COMMUNICATIONS AND NETWORKS , 11권 2호 , 2009
            </li>
            <li>
              Color Preference and Personality Modeling Using Fuzzy Reasoning
              Rule , LECTURE NOTES IN COMPUTER SCIENCE , 3984권 2006호 , 2006
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              개발에 관한 연구, 한국 ITS 학회 논문지, 19권 6호, pp. 192~207 ,
              2020
            </li>
            <li>
            ...
            <li>
              심층 신경망의 더블 프루니 기법의 적용 및 성능 분석에 관한 연구,
              융합 정보 논문지, 10권 8호, pp. 23~34 , 2020
            </li>
            <li>
            ...
            <li>
              재활 보조 기기를 위한 FDM 3D 프린팅 기반 PLA 출력물의 어닐링에
              따른 최적화, 재활복지공학회 논문지, 14권 1호, pp. 50~58 , 2020
            </li>
            ...
            <li>
              ...
              재활복지공학회논 문지, 13권 4호, pp. 333~339 , 2019
            </li>
            <li>
            ...
            <li>
              Deep Convolutional Neural Network를 이용한 주차장 차량 계수
              시스템, 한국 ITS 학회 논문지, 17권 5호, pp. 173~187 , 2018
            </li>
            <li>
              대각 측량 방식을 이용한 실내 측위 정확도 개선에 관한 연구, 한국
              ITS 학 회 논문지, 17권 5호, pp. 160~172 , 2018
            </li>
            <li>
            ...
            <li>
              듀얼 노즐 FDM 3D프린터를 이용한 정전용량 유연-압력센서 개발 및
              분석 , 재활복지공학회 논문지, 12권 4호, pp. 232~240 , 2018
            </li>
            <li>
            ...
            <li>
              차량용 레이더 센서를 위한 다중 타깃 알고리즘의 구현과 평가, 한국
              ITS 학회 논문지, 16권 2호, pp. 105~115 , 2017
            </li>
            <li>
            ...
            <li>
              3축 가속도 센서와 족압 감지 시스템을 활용한 보행 모니터링 시스템
              개 발, 재활복지공학회 논문지, 10권 3호, pp. 199~206 , 2016
            </li>
            <li>
            ...
            <li>
              아마추어 양궁 선수의 풀드 로우에서의 양팔 움직임과 점수 간
              상관관계 연 구, 재활복지공학회 논문지, 10권 1호, pp. 101~106 ,
              2016
            </li>
            <li>
              차량 검출 GMM 2.0을 적용한 도로 위의 차량 검출 시스템 구축,
              한국통신 학회 논문지, 40권 11호, pp. 2291~2297 , 2015
            </li>
            <li>
              인코더를 이용한 2축 각도 기반 보행 불균형 평가 시스템 연구,
              Journal of Institute of Control, Robotics and Systems , 21권 5호,
              pp. 401~406 , 2015
            </li>
            <li>
              음성 검출 기반의 저 연산 이득 제어 알고리즘, 한국통신학회 논문지,
              40 권 5호, pp. 924~930 , 2015
            </li>
            <li>
              UWB 기반 선박 네트워크에서 효율적인 전송 기법, 한국통신학회
              논문지, 39권 11호, pp. 1151~1158 , 2014
            </li>
            <li>
            ...
            <li>
              상황인식 기반 해양 디지털 선박 상황 진단 시스템 구현 및 설계,
              한국통 신학회 논문지, 35권 6호, 2010
            </li>
            <li>
              실내 측위 결정을 위한 Fingerprinting Bayesian 알고리즘,
              한국통신학회 논문지, 35권 6호, 2010
            </li>
            <li>
            ...
            <li>
              IT 분야 공학교육인증 이수자의 실무역량에 대한 기업과 졸업생 인식
              비 교, 직업교육연구, 29권 1호, 2010
            </li>
            <li>
              외국인 인재 유치 및 활용을 위한 정책 모형 연구, 한국콘텐츠학회
              논문 지, 10권 3호, 2010
            </li>
            <li>
            ...
            <li>
              뇌파 기반 집중도 전송 및 BCI 적용에 관한 연구, 전자공학회 논문지,
              46 권 2호, 2009
            </li>
            <li>
            ...
            <li>
              네트워크 보드게임에서의 임의 종료 관리 시스템에 대한 연구,
              감성과학 , 10권 3호, 2007
            </li>
            <li>
              개선된 클로버 알고리즘을 이용한 컨테이너 작업 스케줄링에 관한
              연구, 한국 해양정보통신학회 논문지, 11권 10호, 2007
            </li>
            <li>
            ...
            <li>
              유전자 알고리즘과 신경망을 이용한 MMORPG의 지능 캐릭터 구현에 관
              한 연구, 멀티미디어학회 논문지, 10권 5호, 2007
            </li>
            <li>
              Adaboost 기반의 실시간 고속 얼굴 검출 및 추적 시스템의 개발,
              제어·로 봇·시스템학회 논문지, 13권 11호, 2007
            </li>
            <li>
              복부 근전도 분석을 통한 복부 비만 측정 시스템 개발, 센서학회지,
              16권 5호, 2007
            </li>
            <li>
            ...
            <li>
              방전 신호 검출에 의한 전기화재 예측, 한국 해양정보통신학회 논문지,
              8 권 2호, 2004
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              번호판 인식 방법 및 시스템(SYSTEM AND METHOD FOR RECOGNIZING
              LICENSE PLATES), 2020
            </li>
            <li>
            ...
            <li>
              휠체어의 주행 정보 및 사용자의 운전 정보에 기반하여 안전성을
              평가하 는 휠체어 운영 시스템 및 방법(WHEELCHAIR OPERATION SYSTEM
              AND METHOD FOR EVALUATING SAFETY BASED ON WHEELCHAIR'S DRIVING
              INFORMATION) , 2020
            </li>

            <li>
              증강현실 기반 3D 프린터 유지 보수 방법 및 시스템(3D PRINTER
              MAINTAIN METHOD AND SYSTEM WITH AUGMENTED REALITY), 2020
            </li>

            <li>
              대형 출력물의 프린팅을 위한 다중 3D 프린터의 프린팅 스케줄링 방법
              및 시스템(METHOD AND SYSTEM FOR PRINTING SCHEDULING OF MULTIPLE 3D
              PRINTER FOR LARGE PRINTED OUTPUT), 2020
            </li>

            <li>
              펠티어 소자를 이용한 3D 프린터 출력물 탈착용 자동 히팅 베드 냉각
              방 법 및 시스템(METHOD AND SYSTEM FOR COOLING AUTOMATIC HEATING
              BED FOR 3D PRINTER OUTPUT DISCONNECTION USING PELTIER EFFECT
              DEVICE), 2020
            </li>

            <li>
              영상의 쇼트 분류를 이용한 사용자 맞춤형 영상 추천
              시스템(Customized image recommendation system using shot
              classification of images), 2020
            </li>
            ...
            <li>
              착용 및 탈거가 쉬운 보청기(A hearing aid with easy wearing and
              easy removing), 2019
            </li>

            <li>
              증강현실을 이용한 3D 프린터 인쇄 물체 정보 표시 시스템 및 방법
              (SYSTEM AND METHOD FOR DISPLAYING PRINTED OBJECT DISPLAY
              INFORMATION BY 3D PRINTER USING AUGMENTED REALITY), 2019
            </li>

            <li>
              3D 프린터 필라멘트 공급 통합 모니터링 장치 및 시스템 그리고 방법
              (APPARATUS, SYSTEM AND METHOD FOR MONITORING FILAMENT OF 3
              DIMENSION PRINTER), 2019
            </li>
            ...
            <li>
              레이저 회전을 이용하여 3차원 물체를 판별하는 장치 및 방법
              (APPARATUS AND METHOD FOR DETERMING 3D OBJECT USING ROTATION OF
              LASER), 2017
            </li>
